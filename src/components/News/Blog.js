        ...
        <>
            <div className="single-post-area">
                ...
                <p>
                    ...
                    over tit blower mush the bees knees chip shop the BBC, say lemon squeezy
                ...
                <blockquote>
                    <p>
                        I dont want no agro brilliant are you taking the piss skive off super boot
                        chancer dont get shirty.
                    </p>
                    <cite>Indigo Violet</cite>
                </blockquote>
                <p>
                    That faff about the full monty blower bubble and squeak cheeky old matie boy
                    burke, the bees knees what a load of rubbish golly gosh mufty is Elizabeth
                    squiffy, lurgy chimney pot Jeffrey Richard naff Queens English cheesed off. Old
                    ...
                    Harry dont get shirty with me arse over tit he lost his bottle spiffing good
                    ...
                    amongst, lavatory twit bits and bobs pardon you daft ummm Im telling. Blatant
                    ...
                    lavatory boot victoria sponge spend a penny grub ummm Im telling, absolutely
                    bladdered A bit of hows your father arse over tit do one chimney pot tomfoolery
                        ...
                        <div className="single-comment">
                            ...
                            <div className="comment">
                                <p>
                                    ...
                                    twit bits and bobs pardon you daft ummm Im telling.
                                </p>
                            </div>
                                ...
                                <div className="single-comment">
                                    ...
                                    <div className="comment">
                                        <p>
                                            ...
                                            pardon you daft ummm Im telling. Blatant matie boy say
                                ...
                                <div className="single-comment">
                                    ...
                                    <div className="comment">
                                        <p>
                                            ...
                                            and bobs pardon you daft ummm Im telling.
                                        </p>
                                    </div>
                                    <a className="comment-reply-link" href="#">
                                        <i className="fal fa-reply"></i>Reply
